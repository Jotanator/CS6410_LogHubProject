...
if __name__ == '__main__':
    ...
    overlap = set(df_normal['EventId'].unique()) & set(df_abnormal['EventId'].unique())
    ...
    # Test Normal #
    ###############
    print(len(event_id_map))
    print(len(df_normal[df_normal["EventId"] == '7785b392']))
    # deeplog_test_normal = deeplog_df_transfer(df_normal, event_id_map)
    # print(deeplog_test_normal)
    # exit()
